			...
			<div id="content" class="span10">
				...
				<ul class="breadcrumb">
					...
					<li>
						<i class=""></i>
						<a href="#">Consulta Monitoria Tel</a>
					</li>
				</ul>
					...
					<div class="row-fluid sortable">
						<div class="box span12"> <!--/span form-escuta-->
									...
									<div class="control-group">
										...
										<div class="controls">
											<select id="selectAnalista" data-rel="chosen" name="id_func">
												...
												<?php
												$select = "SELECT matricula, nome FROM funcionario  WHERE id_grupo = 7004 AND tipo_atend like 'TELEFONE' ORDER BY 2";
							...
							<div class="form-actions ">
								<button type="submit" class="btn btn-primary" name="consulta_tel">Consultar</button>
		...
		<?php include("control_consultaTel.php");?>
