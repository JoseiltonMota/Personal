					...
					<div class="row-fluid sortable">
						<div class="box span12"> <!--/span form-escuta-->
							...
							<div class="box-content">
								<fieldset>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select id="selectAnalista" style="width: 350px;" data-rel="chosen" placeholder="Selecione o analista" name="matricula">
												<option value=""></option>
												<?php
								...
								<!-- <div class="control-group">
									...
									<div class="controls">
										<select id="selectGrupo" data-rel="chosen" style="width: 300px;" placeholder="Selecione o grupo" name="id_grupo">
											<?php
							...
							<div class="form-actions ">
								<button type="submit" class="btn btn-primary" name="consulta_monitoria">Consultar</button>
		...
		<?php include_once("controller/consulta/consulta_monitoria.php");?>
